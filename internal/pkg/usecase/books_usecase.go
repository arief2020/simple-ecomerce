...
import (
	...
	booksmodel "tugas_akhir_example/internal/pkg/dto"
...
func (alc *BooksUseCaseImpl) GetAllBooks(ctx context.Context, params booksmodel.BooksFilter) (res []booksmodel.BooksResp, err *helper.ErrorStruct) {
	...
	if errRepo != nil {
		...
		helper.Logger(utils.GetFunctionPath(), helper.LoggerLevelError, fmt.Sprintf("Error at GetAllBooks : %s", errRepo.Error()))
		return res, &helper.ErrorStruct{
